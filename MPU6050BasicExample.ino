...
enum Ascale { AFS_2G = 0,
              AFS_4G,
              AFS_8G,
              AFS_16G };

enum Gscale { GFS_250DPS = 0,
              GFS_500DPS,
              GFS_1000DPS,
              GFS_2000DPS };
...
void loop() {
    ...
    if (deltat > 500) {
        ...
        display.print((int16_t)(1000 * ax));
        display.setCursor(24, 16);
        display.print((int16_t)(1000 * ay));
        display.setCursor(48, 16);
        display.print((int16_t)(1000 * az));
        display.setCursor(72, 16);
        display.print("mg");

        display.setCursor(0, 24);
        display.print((int16_t)(gx));
        display.setCursor(24, 24);
        display.print((int16_t)(gy));
        display.setCursor(48, 24);
        display.print((int16_t)(gz));
